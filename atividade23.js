...
function calcular() {
    ...
    const litros = dinheiro / 5.0;
    const km = litros * 20.0;

    const resultado = `Com R$ ${dinheiro.toFixed(2)}, você pode comprar ${litros.toFixed(2)} litros de combustível e andar ${km.toFixed(2)} km.`;
